...
-- Table `mydb`.`SGC_PAIS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_PAIS` (
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_REGION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_REGION` (
  ...
  CONSTRAINT `fk_SGC_REGION_SGC_PAIS`
    ...
    REFERENCES `mydb`.`SGC_PAIS` (`PAI_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_CIUDAD`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_CIUDAD` (
  ...
  CONSTRAINT `fk_SGC_CIUDAD_SGC_REGION1`
    ...
    REFERENCES `mydb`.`SGC_REGION` (`REG_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_PLAYA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_PLAYA` (
  ...
  CONSTRAINT `fk_SGC_PLAYA_SGC_CIUDAD1`
    ...
    REFERENCES `mydb`.`SGC_CIUDAD` (`CIU_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_FOTO_PLAYA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_FOTO_PLAYA` (
  ...
  CONSTRAINT `fk_SGC_FOTO_PLAYA_SGC_PLAYA1`
    ...
    REFERENCES `mydb`.`SGC_PLAYA` (`PLA_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_OLEAJE_PLAYA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_OLEAJE_PLAYA` (
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_TIEMPO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_TIEMPO` (
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_PRONOSTICO_TIEMPO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_PRONOSTICO_TIEMPO` (
  ...
  CONSTRAINT `fk_SGC_PRONOSTICO_TIEMPO_SGC_TIEMPO1`
    ...
    REFERENCES `mydb`.`SGC_TIEMPO` (`TIE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_PERFIL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_PERFIL` (
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_USUARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_USUARIO` (
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_CAMPANHA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_CAMPANHA` (
  ...
  CONSTRAINT `fk_SGC_CAMPANHA_SGC_USUARIO1`
    ...
    REFERENCES `mydb`.`SGC_USUARIO` (`USR_CORREO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_BITACORA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_BITACORA` (
  ...
  CONSTRAINT `fk_SGC_BITACORA_SGC_CAMPANHA1`
    ...
    REFERENCES `mydb`.`SGC_CAMPANHA` (`CAMP_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SGC_BITACORA_SGC_PERFIL1`
    FOREIGN KEY (`SGC_PERFIL_PERF_NUMERO`)
    REFERENCES `mydb`.`SGC_PERFIL` (`PERF_NUMERO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_MEDICION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_MEDICION` (
  ...
  CONSTRAINT `fk_SGC_MEDICION_SGC_BITACORA1`
    ...
    REFERENCES `mydb`.`SGC_BITACORA` (`BIT_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_INTEGRANTES_BITACORA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_INTEGRANTES_BITACORA` (
...
-- -----------------------------------------------------
-- Table `mydb`.`SGC_MAREA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`SGC_MAREA` (
