...
<body>
    ...
    <div class="container">
        ...
        <?php   
                foreach ($mostrarCiudad as $fila2)
                {
                ?>
                  <h1 class="page-header">  <small><?php echo $fila2->CIU_NOMBRE;  ?>.</small>
                </h1>
                <?php
            }
        ?>
...
<?php
        if(is_array($mostrarCiudad) && !empty($mostrarCiudad))
        {
            foreach ($mostrarPlaya as $fila2) 
            {
            ?>
