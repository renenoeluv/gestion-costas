...
<head>
    ...
    <!-- Custom CSS -->
    <link href=<?php echo base_url("plantilla/css/modern-business.css"); ?> rel="stylesheet">
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="fincampania.html">Inicio Sección</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="alert alert-info alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <i class="fa fa-info-circle"></i> La Mejor playa en tu zona es: <a <?php
                        if(is_array($mostrarPlaya) && !empty($mostrarPlaya))
                        {
                        foreach ($mostrarPlaya as $fila) 
                        {
                        ?>
                        <h4><i class=""></i><?php echo $fila->PLA_NOMBRE; ?></h4></a>.
                            <?php
                    }
                }
            ?>
           ...
           <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        {
                        ?>
                        <h4><i class="fa fa-fw fa-check"></i><?php echo $fila->PLA_NOMBRE; ?></h4>
                            <?php
                    }
                }
            ?>
        ...
        ?>                
                        <a href="<?php echo site_url('/playas') ?>" class="btn btn-default">Ver información tecnica de playa.</a>
                    </div>
                </div>
            </div>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Desarrollo Web &copy; Informatica UV 2016</p>
                </div>
            </div>
        </footer>
    ...
    <script src="final/js/bootstrap.min.js"></script>
