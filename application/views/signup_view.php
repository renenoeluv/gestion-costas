...
<div class="container">
	<div class="row">
		<div class="col-md-4 col-md-offset-4 well">
			...
			<div class="form-group">
				...
				<input class="form-control" name="cpassword" placeholder="Confirmar Password" type="password" />
				<span class="text-danger"><?php echo form_error('cpassword'); ?></span>
			</div>

			<div class="form-group">
				<button name="submit" type="submit" class="btn btn-info">Salir</button>
	...
	<div class="row">
		...
		¿Ya se registro? <a href="<?php echo base_url(); ?>index.php/login">Ingrese acá</a>
		</div>
	</div>
</div>
