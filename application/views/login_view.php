	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbar1">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="<?php echo base_url(); ?>index.php/signup">Registrar</a></li>
				<?php } ?>
			</ul>
		</div>
	</div>
...
<div class="container">
	<div class="row">
		...
		<?php $attributes = array("name" => "loginform");
			...
			<div class="form-group">
				<button name="submit" type="submit" class="btn btn-info">Ingresar</button>
				<button name="cancel" type="reset" class="btn btn-info">Cancelar</button>
			</div>
		<?php echo form_close(); ?>
	...
	<div class="row">
		...
		¿Nuevo usuario? <a href="<?php echo base_url(); ?>index.php/signup">Registrese aquí</a>
		</div>
	</div>
</div>
